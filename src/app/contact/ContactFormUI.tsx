...
export default function ContactFormUI({
      ...
      <div className="mx-auto max-w-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm">
        ...
        {isMocked && (
          <div className="mt-4 p-3 rounded bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm">
            Note: Running in mock mode — this submission was not forwarded to
            Formspree.
          </div>
        )}
      </div>
  ...
  const normalizedFormspreeErrors: { message?: string }[] = Array.isArray(
    formspreeErrors,
  )
    ...
    >
      {isMocked && (
        <div className="mb-4 p-3 rounded bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm">
          Note: The server is running in mock mode — submissions are not
          forwarded to Formspree.
        </div>
      )}
      <input
        name="hp"
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-3 sm:gap-4 justify-between w-full sm:w-auto">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 text-left sm:text-right">
